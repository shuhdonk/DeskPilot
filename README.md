...
Deskpilot is built to run unattended AI agents safely on your hardware. It implements several robust security and performance patterns:
    ...
    SSRF & DNS-Rebinding Protection: The fetch_url tool explicitly resolves and drops connections to loopback (127.0.0.1), LAN (RFC1918), and cloud-metadata addresses. (Can be bypassed for local dev via the "Allow Local Network" setting).
...
See Linux and Windows Install files for instructions.
\---
